class Baicizhan {
    ...
    processData(data) {
        ...
        if (wordInfo.df != undefined)
            defsContent += `<div class='bcz-section'><img width="280px" src='${wordInfo.df}' /></div>`;
        ...
        if (wordInfo.img != undefined)
            defsContent += `<div class='bcz-section'><img width="280px" src='${wordInfo.img}' /></div>`;
        if (wordInfo.tv != undefined)
            defsContent += `<div class='bcz-section'><video width="280px" controls><source src='${wordInfo.tv}' type="video/mp4"></video></div>`;
        return defsContent;
    }
            ...
            try {
                ...
                xhr.addEventListener('loadend', () => {
                    if (xhr.responseText == 'preflight')
                        reject('CORS OPTIONS Request - Dropped.');
