...
```
javascript:(function(){abkl_options={deck:"Antimoon",type:"Antimoon",word:"expression",defs:"glossary",sent:"sentence"};if(window.myBookmarklet!==undefined){myBookmarklet();}else{var s=document.createElement("script");s.type="text/javascript",s.src="https://rawgit.com/ninja33/anki-bookmarklet/master/abkl_ankiconnect.js?bust="+new Date().getTime(),document.body.appendChild(s)}})();
```
