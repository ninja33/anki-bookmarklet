...
```
javascript:(function(){deckName='Default';typeName='Basic';fieldWord='Front';fieldSentence='Back';if(window.myBookmarklet!==undefined){myBookmarklet();}else{var s=document.createElement("script");s.type="text/javascript",s.src="https://rawgit.com/ninja33/anki-bookmarklet/master/abkl_ankimobile.js?bust="+new Date().getTime(),document.body.appendChild(s)}})();
```
